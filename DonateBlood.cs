...
namespace Assignment2
{
    ...
    {
        private static String blooddonator, bloodgroup, bloodunit;
        public DonateBlood()
        {
            InitializeComponent();
        }
        ...
        private void buttonRequestSubmit_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("INSERT INTO BloodDonator VALUES(@DonorName,@BloodGroup,@BloodUnits)", con);
            cmd.Parameters.AddWithValue("@DonorName", blooddonator);
            ...
            cmd.ExecuteReader();
            con.Close();
            MessageBox.Show("Donated Blood Succesfully");
